...
for (i in 1:runs) {
    ...
    acc[i, 6, 1] <- cor(as.vector(dcet[coridx]), as.vector(dcei[coridx]), method = "s")
    ...
    coridx <- which(dcet != 0 & dcei != 0)
    acc[i, 3, 1] <- cor(as.vector(dcet[coridx]), as.vector(dcei[coridx]), method = "s")
    ...
    coridx <- which(dcet != 0 & dcei != 0)
    acc[i, 4, 1] <- cor(as.vector(dcet[coridx]), as.vector(dcei[coridx]), method = "s")
    ...
    coridx <- which(dcet != 0 & dcei != 0)
    acc[i, 5, 1] <- cor(as.vector(dcet[coridx]), as.vector(dcei[coridx]), method = "s")
    ...
    coridx <- which(dcet != 0 & dcei != 0)
    acc[i, 1, 1] <- cor(as.vector(dcet[coridx]), as.vector(dcei[coridx]), method = "s")
    ...
    acc[i, 2, 1] <- cor(as.vector(dcet[coridx]), as.vector(dcer[coridx]), method = "s")
