...
L <- scale(lib.size, center = FALSE)


linkfun <- "log"
summary(glm2::glm2(B ~ A, family=MASS::negative.binomial(theta=10, link=linkfun)))

summary(glm2::glm2(B.s ~ A.s, family=MASS::negative.binomial(theta=10, link=linkfun)))

summary(glm2::glm2(B.s ~ A.s*L, family=MASS::negative.binomial(theta=10, link=linkfun)))
