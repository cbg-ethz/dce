...
n <- 10; # genes
m <- c(200, 200); # samples: wt and mut
runs <- 10;
perturb <- 0; # add (positive fraction) or remove (negative) edges
p <- "runif"; # edge probability
bootstrap <- c(0, "NB", "Gaussian"); # number of bootstrap runs for the methods 
truepos <- 1; # fraction of true positive effects
test <- 10 # number of permutations for empirical p-value
...
plot.dceSim(simRes, col = col, border = col, showMeth = c(2,5,3,6,1,4), showFeat = c(2,1,4,5,6,3), methNames = c("Gaussian", "Gaussian\n bootstrap", "Neg. Binomial", "NB\n bootstrap", "random", "correlation"))
