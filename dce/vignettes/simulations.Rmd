...
sd <- 1 # standard deviation for variable distributions
...
for (i in 1:runs) {
    ...
    dn <- rmvDAG_2(m[1], normal, normpars = c(0,sd))
    
    tumor <- newWeights(normal, lB, uB, truepos) # resample edge weights
    dt <- rmvDAG_2(m[2], tumor, normpars = c(0,sd))
...
par(mfrow=c(2,3))
boxplot(acc[seq_len(runs), 1:4, 1], col = c(rgb(1,0,0), rgb(0.5,0.5,0.5), rgb(0,1,0), rgb(0,0,1)), main="Correlation")
boxplot(acc[seq_len(runs), 1:4, 2], col = c(rgb(1,0,0), rgb(0.5,0.5,0.5), rgb(0,1,0), rgb(0,0,1)), main="Distance")
boxplot(acc[seq_len(runs), 1:4, 3], col = c(rgb(1,0,0), rgb(0.5,0.5,0.5), rgb(0,1,0), rgb(0,0,1)), main="Sensitivity")
boxplot(acc[seq_len(runs), 1:4, 4], col = c(rgb(1,0,0), rgb(0.5,0.5,0.5), rgb(0,1,0), rgb(0,0,1)), main="Specificity")
boxplot(acc[seq_len(runs), 1:4, 5], col = c(rgb(1,0,0), rgb(0.5,0.5,0.5), rgb(0,1,0), rgb(0,0,1)), main="Accuracy")
```
