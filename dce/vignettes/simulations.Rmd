...
First we set specfici parameters to define the scope and noise levels
...
random baseline and competing methods bla and blabla. {\color{red}see
github project}

After simulation we use a boxpülot to compare the accuracies of the
respective methods.
