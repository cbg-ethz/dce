...
ggsave(plot=gg1, filename=snakemake@output[[1]], width=8, height=6)
...
ggsave(plot=gg2, filename=snakemake@output[[2]], width=8, height=6)


ggsave(plot_grid(gg1,gg2), filename=snakemake@output[[3]], width=14, height=6.5)